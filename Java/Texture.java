final class Texture extends DrawingArea {
	...
	public static void drawLDTexturedTriangle(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2,
		...
		if (i <= j && i <= k) {
			...
			if (j < k) {
				...
				if (i != j && i8 < i7 || i == j && i8 > k7) {
					...
					i = anIntArray1472[i];
					while (--j >= 0) {
						drawLDTexturedScanline(DrawingArea.pixels, ai, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5,
								j6, i5, l5, k6);
						j1 += i8;
						l += i7;
						i2 += j8;
					...
					while (--k >= 0) {
						drawLDTexturedScanline(DrawingArea.pixels, ai, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5,
								j6, i5, l5, k6);
						j1 += i8;
						i1 += k7;
						i2 += j8;
				...
				i = anIntArray1472[i];
				while (--j >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6,
							i5, l5, k6);
					j1 += i8;
					l += i7;
					i2 += j8;
				...
				while (--k >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, i, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6,
							i5, l5, k6);
					j1 += i8;
					i1 += k7;
					i2 += j8;
			...
			if (i != k && i8 < i7 || i == k && k7 > i7) {
				...
				i = anIntArray1472[i];
				while (--k >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6,
							i5, l5, k6);
					i1 += i8;
					l += i7;
					l1 += j8;
				...
				while (--j >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6,
							i5, l5, k6);
					j1 += k7;
					l += i7;
					i2 += l7;
			...
			i = anIntArray1472[i];
			while (--k >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5,
						l5, k6);
				i1 += i8;
				l += i7;
				l1 += j8;
			...
			while (--j >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5,
						l5, k6);
				j1 += k7;
				l += i7;
				i2 += l7;
		...
		if (j <= k) {
			...
			if (k < i) {
				...
				if (j != k && i7 < k7 || j == k && i7 > i8) {
					...
					j = anIntArray1472[j];
					while (--k >= 0) {
						drawLDTexturedScanline(DrawingArea.pixels, ai, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5,
								j6, i5, l5, k6);
						l += i7;
						i1 += k7;
						k1 += j7;
					...
					while (--i >= 0) {
						drawLDTexturedScanline(DrawingArea.pixels, ai, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5,
								j6, i5, l5, k6);
						l += i7;
						j1 += i8;
						k1 += j7;
				...
				j = anIntArray1472[j];
				while (--k >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6,
							i5, l5, k6);
					l += i7;
					i1 += k7;
					k1 += j7;
				...
				while (--i >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6,
							i5, l5, k6);
					l += i7;
					j1 += i8;
					k1 += j7;
			...
			if (i7 < k7) {
				...
				j = anIntArray1472[j];
				while (--i >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, j, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6,
							i5, l5, k6);
					j1 += i7;
					i1 += k7;
					i2 += j7;
				...
				while (--k >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6,
							i5, l5, k6);
					l += i8;
					i1 += k7;
					k1 += j8;
			...
			j = anIntArray1472[j];
			while (--i >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5,
						l5, k6);
				j1 += i7;
				i1 += k7;
				i2 += j7;
			...
			while (--k >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5,
						l5, k6);
				l += i8;
				i1 += k7;
				k1 += j8;
		...
		if (i < j) {
			...
			if (k7 < i8) {
				...
				k = anIntArray1472[k];
				while (--i >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6,
							i5, l5, k6);
					i1 += k7;
					j1 += i8;
					l1 += l7;
				...
				while (--j >= 0) {
					drawLDTexturedScanline(DrawingArea.pixels, ai, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6,
							i5, l5, k6);
					i1 += k7;
					l += i7;
					l1 += l7;
			...
			k = anIntArray1472[k];
			while (--i >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5,
						l5, k6);
				i1 += k7;
				j1 += i8;
				l1 += l7;
			...
			while (--j >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5,
						l5, k6);
				i1 += k7;
				l += i7;
				l1 += l7;
		...
		if (k7 < i8) {
			...
			k = anIntArray1472[k];
			while (--j >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5,
						l5, k6);
				l += k7;
				j1 += i8;
				k1 += l7;
			...
			while (--i >= 0) {
				drawLDTexturedScanline(DrawingArea.pixels, ai, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5,
						l5, k6);
				i1 += i7;
				j1 += i8;
				l1 += j7;
		...
		k = anIntArray1472[k];
		while (--j >= 0) {
			drawLDTexturedScanline(DrawingArea.pixels, ai, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5,
					k6);
			l += k7;
			j1 += i8;
			k1 += l7;
		...
		while (--i >= 0) {
			drawLDTexturedScanline(DrawingArea.pixels, ai, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5,
					k6);
			i1 += i7;
			j1 += i8;
			l1 += j7;
	...
	private static void drawLDTexturedScanline(int ai[], int ai1[], int k, int l, int i1, int j1, int k1, int l1,
	...
	public static void drawHDTexturedTriangle(int y1, int y2, int y3, int x1, int x2, int x3, int l1, int l2, int l3,
			int tx1, int tx2, int tx3, int ty1, int ty2, int ty3, int tz1, int tz2, int tz3, int tex) {
		l1 = 0x7f - l1 << 1;
		l2 = 0x7f - l2 << 1;
		l3 = 0x7f - l3 << 1;
		...
		if (y1 <= y2 && y1 <= y3) {
			...
			if (y2 < y3) {
				...
				if (y1 != y2 && i8 < i7 || y1 == y2 && i8 > k7) {
					...
					while (--y2 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y1, x3 >> 16, x1 >> 16, l3, l1, l4, k5, j6, i5,
								l5, k6);
						x3 += i8;
						x1 += i7;
						l3 += j8;
					...
					while (--y3 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y1, x3 >> 16, x2 >> 16, l3, l2, l4, k5, j6, i5,
								l5, k6);
						x3 += i8;
						x2 += k7;
						l3 += j8;
				...
				y1 = anIntArray1472[y1];
				while (--y2 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1, x1 >> 16, x3 >> 16, l1, l3, l4, k5, j6, i5, l5,
							k6);
					x3 += i8;
					x1 += i7;
					l3 += j8;
				...
				while (--y3 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1, x2 >> 16, x3 >> 16, l2, l3, l4, k5, j6, i5, l5,
							k6);
					x3 += i8;
					x2 += k7;
					l3 += j8;
			...
			if (y1 != y3 && i8 < i7 || y1 == y3 && k7 > i7) {
				...
				y1 = anIntArray1472[y1];
				while (--y3 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1, x2 >> 16, x1 >> 16, l2, l1, l4, k5, j6, i5, l5,
							k6);
					x2 += i8;
					x1 += i7;
					l2 += j8;
				...
				while (--y2 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y1, x3 >> 16, x1 >> 16, l3, l1, l4, k5, j6, i5, l5,
							k6);
					x3 += k7;
					x1 += i7;
					l3 += l7;
		...
		if (y2 <= y3) {
			...
			if (y3 < y1) {
				...
				if (y2 != y3 && i7 < k7 || y2 == y3 && i7 > i8) {
					...
					while (--y3 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y2, x1 >> 16, x2 >> 16, l1, l2, l4, k5, j6, i5,
								l5, k6);
						x1 += i7;
						x2 += k7;
						l1 += j7;
					...
					while (--y1 >= 0) {
						drawHDTexturedScanline(DrawingArea.pixels, ai, y2, x1 >> 16, x3 >> 16, l1, l3, l4, k5, j6, i5,
								l5, k6);
						x1 += i7;
						x3 += i8;
						l1 += j7;
				...
				y2 = anIntArray1472[y2];
				while (--y3 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y2, x2 >> 16, x1 >> 16, l2, l1, l4, k5, j6, i5, l5,
							k6);
					x1 += i7;
					x2 += k7;
					l1 += j7;
				...
				while (--y1 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y2, x3 >> 16, x1 >> 16, l3, l1, l4, k5, j6, i5, l5,
							k6);
					x1 += i7;
					x3 += i8;
					l1 += j7;
			...
			if (i7 < k7) {
				...
				y2 = anIntArray1472[y2];
				while (--y1 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y2, x3 >> 16, x2 >> 16, l3, l2, l4, k5, j6, i5, l5,
							k6);
					x3 += i7;
					x2 += k7;
					l3 += j7;
				...
				while (--y3 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y2, x1 >> 16, x2 >> 16, l1, l2, l4, k5, j6, i5, l5,
							k6);
					x1 += i8;
					x2 += k7;
					l1 += j8;
		...
		if (y1 < y2) {
			...
			if (k7 < i8) {
				...
				while (--y1 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y3, x2 >> 16, x3 >> 16, l2, l3, l4, k5, j6, i5, l5,
							k6);
					x2 += k7;
					x3 += i8;
					l2 += l7;
				...
				while (--y2 >= 0) {
					drawHDTexturedScanline(DrawingArea.pixels, ai, y3, x2 >> 16, x1 >> 16, l2, l1, l4, k5, j6, i5, l5,
							k6);
					x2 += k7;
					x1 += i7;
					l2 += l7;
